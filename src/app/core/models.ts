...
export interface Patient { id: string; patientId: string; firstName: string; lastName: string; dateOfBirth: string; age?: number; sex?: string; mobileNumber?: string; emailAddress?: string; homeAddress?: string; bloodType?: string; philHealthInsuranceId?: string; allergies?: string; conditions?: string; notes?: string; [key: string]: unknown; }
