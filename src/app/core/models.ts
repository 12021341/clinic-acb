...
export interface Patient { id: string; patientId: string; firstName: string; lastName: string; dateOfBirth: string; age?: number; sex?: string; mobileNumber?: string; emailAddress?: string; homeAddress?: string; bloodType?: string; philHealthInsuranceId?: string; bloodPressure?: string; heartRate?: number; respiratoryRate?: number; bodyTemperatureC?: number; oxygenSaturation?: number; weightKg?: number; heightCm?: number; allergies?: string; conditions?: string; notes?: string; [key: string]: unknown; }
